...
func RunRoutes(route fiber.Router, service judge.Service) {
	route.Post("/run/:language/:version?", runLanguageByVersion(service))
}

func runLanguageByVersion(service judge.Service) fiber.Handler {
